      ...
      <div class="container">
        ...
        echo "  
                              ...
                              <div class="item-action-area">
                                 <ul>
                                    <li class="inline-item"><a href="javascript:void(0)"
                                          class=" btn btn-warning text-white" data-toggle="modal"
                                          data-target="#promote-this-ad"> <i class="fa fa-arrow-circle-up text-white"
                                             aria-hidden="true"></i> Promote this ad</a></li>
                                    <li class="inline-item"><a href="../../login.html"><i class="fas fa-heart"></i>Add
                                          to Favourites</a></li>
                                    <li class="inline-item"><a href="../../pages/contact.html"><i
                                             class="fas fa-exclamation-triangle"></i>Report Abuse</a></li>
                           ...
                           <div class="modal-dialog modal-xl bg-light">
                              <div class="modal-content bg-dark border-0 rounded-0">
                                 <div class="modal-header border-0">
                                    <button type="button" class="close text-white p-2" data-dismiss="modal"
                                       aria-label="Close">
        ...
        ?>
            ...
            <div class="">
                  ...
                  <div class="item-review light-shadow-bg">
                     ...
                     <div class="light-box-content">
                        <form action="https://prothomei.com/review" method="POST">
                           ...
                           <input type="hidden" name="_token" value="nEBiN5oCfaAJF6vKPkbvt7SZDx2rbPy6cpnlGVfZ"> <input
                              type="hidden" name="_method" value="POST">
                           <div class="item-text">Your email address will not be published. Required fields are marked *
                           </div>
                           ...
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="comment" id="comment" required cols="30" rows="3"
                                 required></textarea>
                           </div>
                           <div class="form-group">
                              <button type="submit" value="Post Comment" name="submit"
                                 class="item-btn outline-none">SUBMIT</button>
                           </div>
                        </form>
                     </div>
                  </div>
               ...
               <div class="item-related-product light-shadow-bg pb-4 pb-lg-5">
                  ...
                  <div class="light-box-content">
                     <div class="rc-carousel" data-loop="true" data-items="7" data-margin="30"
                        data-custom-nav="#owl-nav1" data-autoplay="true" data-autoplay-timeout="3000"
                        data-smart-speed="1000" data-dots="false" data-nav="false" data-nav-speed="false"
                        data-r-x-small="1" data-r-x-small-nav="false" data-r-x-small-dots="false" data-r-x-medium="2"
                        data-r-x-medium-nav="false" data-r-x-medium-dots="false" data-r-small="2"
                        ...
                        data-r-extra-large="4" data-r-extra-large-nav="false" data-r-extra-large-dots="false">
                        <?php
