	...
	$(document).ready(function() {
		...
		$("body").on("click", ".remove-item", function() {
			...
			$.ajax({
				...
				c_obj.remove();
				toastr.success('Area Deleted Successfully.', 'Success Alert', {
					timeOut: 5000
				});
				getPageData();
			});
		...
		$("body").on("click", ".edit-item", function() {
			...
			var id = $(this).parent("td").data('id');
			var areaname = $(this).parent("td").prev("td").text();
		...
		$(".crud-submit-edit").click(function(e) {
			...
			if (areaname != '') {
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('Area Updated Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
...
<div id="content" class="col-lg-10 col-sm-10">
	...
	<div class="container">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">Area management</div>
