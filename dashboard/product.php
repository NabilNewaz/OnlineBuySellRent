...
<script>
	$(document).ready(function() {
		...
		$(".crud-submit").click(function(e) {
			...
			if (title != '' && description != '' && user_id != '' && areaid != '' && categoryid != '' &&
				subcategoryid != '') {
				$.ajax({
					dataType: 'json',
					type: 'GET',
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('Product Created Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
		...
		$("body").on("click", ".remove-item", function() {
			...
			$.ajax({
				...
				c_obj.remove();
				toastr.success('Product Deleted Successfully.', 'Success Alert', {
					timeOut: 5000
				});
				getPageData();
			});
		...
		$("body").on("click", ".edit-item", function() {
			...
			var id = $(this).parent("td").data('id');
			var title = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td").prev(
				"td").text();
			var description = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td")
				.text();
		...
		$(".crud-submit-edit").click(function(e) {
			...
			if (title != '' && description != '' && user_id != '' && areaid != '' && categoryid != '' &&
				...
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('Product Updated Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
						...
						<form data-toggle="validator" action-data="api/createAdmin.php" method="POST">
							...
							<div class="form-group">
								...
								<input type="text" name="firstname" class="form-control"
									data-error="Please enter firstname." required />
							...
							<div class="form-group">
								...
								<input type="text" name="lastname" class="form-control"
									data-error="Please enter lastname." required />
								<div class="help-block with-errors"></div>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" name="username" class="form-control"
									data-error="Please enter Username." required>
								<div class="help-block with-errors"></div>
							</div>

							<div class="form-group">
								<label class="control-label" for="email">Email:</label>
								<input type="text" name="email" class="form-control" data-error="Please enter email."
									required />
								<div class="help-block with-errors"></div>
							</div>
					...
					<div class="modal-body">
						<form data-toggle="validator" action="api/updateProduct.php" method="put">
							...
							<div class="form-group">
								...
								<input type="text" name="areaid" class="form-control" data-error="Please enter email."
									required />
								<div class="help-block with-errors"></div>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" name="subcategoryid" class="form-control"
									data-error="Please enter group." required />
								<div class="help-block with-errors"></div>
							</div>
