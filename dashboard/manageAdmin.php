...
<script>
	$(document).ready(function() {
		...
		$(".crud-submit").click(function(e) {
			...
			if (firstname != '' && lastname != '' && username != '' && email != '' && password != '' &&
				...
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('Admin Created Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
		...
		$("body").on("click", ".edit-item", function() {
			...
			var id = $(this).parent("td").data('id');
			var firstname = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td")
				.prev("td").text();
			var lastname = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td")
				.text();
		...
		$(".crud-submit-edit").click(function(e) {
			...
			if (firstname != '' && lastname != '' && username != '' && email != '' && password != '' &&
				...
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('Admin Updated Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
