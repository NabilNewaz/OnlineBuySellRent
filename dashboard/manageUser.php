	...
	$(document).ready(function() {
		...
		$(".crud-submit").click(function(e) {
			...
			if (name != '' && username != '' && email != '' && password != '' && phone != '' && usertype !=
				...
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('User Created Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
		...
		$("body").on("click", ".remove-item", function() {
			...
			$.ajax({
				...
				c_obj.remove();
				toastr.success('Admin Deleted Successfully.', 'Success Alert', {
					timeOut: 5000
				});
				getPageData();
			});
		...
		$("body").on("click", ".edit-item", function() {
			...
			var id = $(this).parent("td").data('id');
			var name = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td").prev(
				"td").text();
			var username = $(this).parent("td").prev("td").prev("td").prev("td").prev("td").prev("td")
				.text();
		...
		$(".crud-submit-edit").click(function(e) {
			...
			if (name != '' && username != '' && email != '' && password != '' && phone != '' && usertype !=
				...
				$.ajax({
					...
					getPageData();
					$(".modal").modal('hide');
					toastr.success('User Updated Successfully.', 'Success Alert', {
						timeOut: 5000
					});
				});
			} else {
					...
					<div class="modal-body">
						<form data-toggle="validator" action="api/updateUser.php" method="put">
							...
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control" data-error="Please enter firstname."
									required />
								<div class="help-block with-errors"></div>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" name="phone" class="form-control" data-error="Please enter Username."
									required>
								<div class="help-block with-errors"></div>
							</div>
							...
							<div class="form-group">
								...
								<input type="text" name="usertype" class="form-control" data-error="Please enter group."
									required />
								<div class="help-block with-errors"></div>
							</div>
