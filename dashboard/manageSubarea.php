							...
							<form id="subareamanagement" method="post">
								<table width="100%" border="0" cellspacing="5" cellpadding="0">
									...
									<tr>
										...
										<td>&nbsp;</td>
										<td><input class="clstext" type="text" id="subareaname" name="subareaname"
												placeholder="Subarea Name" required /></td>
									</tr>
									<tr>
...
?>
									...
									<tr>
										<td>
											<input type="button" id="subareaAdd" value="Add Subarea"
												class=" glyphicon glyphicon-edit icon-white btn btn-info editbtn" />
											<input type="button" id="subareaUpdate" value="Update Subarea"
												class=" glyphicon glyphicon-edit icon-white btn btn-info editbtn" />
