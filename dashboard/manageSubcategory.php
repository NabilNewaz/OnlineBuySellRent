...
<script>
	$(document).ready(function(e) {
		...
		$("#subcategoryAdd").click(function(e) {
			...
			$.get("api/subcategoryAdd.php", {
				subcategoryname: subcatname,
				categoryid: catid,
				description: subcatdes,
				action: "add"
			}, function(data) {
				toastr.success('Record Updated Successfully', 'Success Alert', {
					timeOut: 5000
				});
				clearform();
				changePagination('0');
		...
		$("#subcategoryUpdate").click(function(e) {
			...
			$.get("api/subcategoryUpdate.php", {
				...
				toastr.success('Subcategory Updated Successfully.', 'Success Alert', {
					timeOut: 5000
				});
				clearform();
				changePagination('0');
			...
			$.ajax({
				...
				success: function(result) {
					...
					if (result == true) {
						...
						toastr.success('Record Deleted Successfully!!', 'Success Alert', {
							timeOut: 5000
						});
						changePagination('0');
							...
							<form id="subcategorymanagement" method="post">
								<table width="100%" border="0" cellspacing="5" cellpadding="0">
									<tr>
										<th scope="row">id :</th>
										<td>&nbsp;</td>
										<td><input type="text" id="subcatid" readonly placeholder="auto incremant" />
										</td>
									</tr>
									<tr>
										<th scope="row">Subcategory Name : </th>
										<td>&nbsp;</td>
										<td><input class="clstext" type="text" id="subcatname" name="subcatname"
												placeholder="Subcategory Name" required /></td>
									</tr>
									<tr>
...
?>
									...
									<tr>
										...
										<td>&nbsp;</td>
										<td><input class="clstext" type="text" id="subcatdes" name="subcatdes"
												placeholder="Subcategory Description" required /></td>
									</tr>
									<tr>
										<td>
											<input type="button" id="subcategoryAdd" value="Add Subcategory"
												class=" glyphicon glyphicon-edit icon-white btn btn-info editbtn" />
											<input type="button" id="subcategoryUpdate" value="Update Subcategory"
												class=" glyphicon glyphicon-edit icon-white btn btn-info editbtn" />
											<input type="button" id="clearform" value="Clear"
												class=" glyphicon glyphicon-trash icon-white btn btn-danger delbtn " />
									</tr>
								</table>
							</form>
						</div>
