...
if (!(isset($_SESSION['username']))) {
    header("location: login.php?referer=change-password");
}
?>
<!DOCTYPE html>
                        ...
                        <div class="col-lg-3 sidebar-break-sm sidebar-widget-area mt-0" id="sticky-sidebar">
                            <div
                                ...
                                <ul class="nav nav-tabs flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="change-password.php">Change
                                            Password</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="light-box-content">
                                            <form action="/user/profile/change-password" method="POST">
                                                <input type="hidden" name="_token"
                                                    value="Y4fpkaGacEVP9LoHsYNsMfnQnPuO2JxhCB1g0XNk"> <input
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input type="password" value="" class="form-control "
                                                                    name="old_password" id="old-password" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
