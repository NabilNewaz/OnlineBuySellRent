                    ...
                    <div class="col-lg-6">
                        <div class="form-box login-form shadow p-3">
                            ...
                            <div class="d-flex justify-content-between py-3">
                                <div class="pr-1 w-50">
                                    <a href="" class="btn btn-block btn-primary btn-block"><i class="fab fa-facebook"></i> Login with Facebook</a>
                                </div>
                                <div class="pl-1 w-50">
                                    <a href="" class="btn btn-block btn-danger btn-block"><i class="fab fa-google"></i> Login with Google</a>
                                </div>
                            </div>
                            <form method="POST" action="" name="signup">
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <div class=text-center>
                                        <div class="form-group">
                                            <input type="submit" value="Login" name="singin" id="singin" class="submit-btn">
                                        </div>
                                    </div>
                                </div>
