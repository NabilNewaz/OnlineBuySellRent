...
<head>
    ...
    <meta name="csrf-token" content="nEBiN5oCfaAJF6vKPkbvt7SZDx2rbPy6cpnlGVfZ">
    <title>Rent2SellBD - Buy, Sell, Rent Anything.</title>
    ...
    <section id="content">
        <div class="container fwhite">
            <div class="row hcontent">
                <div class="col-md-6">
                    <h3 style="font-weight: bold;">Welcome to Rent2SellBD</h3>
                    <h3>The largest rental service in Bangladesh!</h3><br>
                    <p>Buy, sell and rent everything from used cars to mobile phones and computers,<br> or search for
                        property and more <strong>in Bangladesh - for free!</strong></p>
                    <br>
                    ...
                    <p class="iconf">
                        <a class="icon" href="#"><img style="padding-bottom:2px;" width="55" height="55"
                            ...
                            class="bg-warning">&nbsp;NEW!&nbsp;</strong>&nbsp;Great deals delivered straight to your
                        doorstep
                    </p>
                </div>
                <div class="col-md-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="9.9 0 26.1 36">
                        <style>
                            ...
                            .city:hover .city-body,
                            .city.is-active .city-body {
                                fill: #8c1211;
                                filter: none;
                            }
                        ...
                        <defs>
                            ...
                            <filter id="out2" width="140%" height="140%">
                            ...
                            <linearGradient id="g1" x1="0" y1="0" x2="0" y2="100%">
                                <stop offset="0%" stop-color="#ff5f5e" />
                                <stop offset="100%" stop-color="#FFFF00" />
                            </linearGradient>
                            <filter id="in">
                                <feOffset dx="0" dy=".1" in="SourceGraphic" />
                                <feGaussianBlur stdDeviation=".05" result="b" />
                                <feComposite operator="out" in="SourceGraphic" result="m" />
    ...
    <section class="section-padding-top-heading">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="catWiseItems.php?id=15">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Vehicle</h3>
                                <div class="item-count">87 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="catWiseItems.php?id=1">
                            <div class="item-icon">
                                <img src="images/1615003873JRusZ.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Book &amp; Magazine</h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="catWiseItems.php?id=5">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Electronics</h3>
                                <div class="item-count">1078 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-adaa07.html?category=5">
                            <div class="item-icon">
                                <img src="images/16150053460Qclp.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Home &amp; Living</h3>
                                <div class="item-count">116 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="catWiseItems.php?id=13">
                            ...
                            <div class="item-content">
                                <h3 class="item-title">Land &amp; Property</h3>
                                <div class="item-count">25 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-ada771.html?category=8">
                            <div class="item-icon">
                                <img src="images/1615008742hbVcV.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Services</h3>
                                <div class="item-count">38 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-ad25f6.html?category=10">
                            <div class="item-icon">
                                <img src="images/1615005749VZy8P.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Fashion &amp; Life Style</h3>
                                <div class="item-count">92 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-adefaf.html?category=11">
                            <div class="item-icon">
                                <img src="images/1615002929hWPEN.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Hobby, Sports &amp; Kids</h3>
                                <div class="item-count">12 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-ad18c9.html?category=12">
                            <div class="item-icon">
                                <img src="images/1615003834UbBg5.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Pet &amp; Animal</h3>
                                <div class="item-count">12 Ad</div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="category-box-layout1">
                        <a href="ad/all-ad7b86.html?category=13">
                            <div class="item-icon">
                                <img src="images/1615002872VJGMH.png" alt="category">
                            </div>
                            <div class="item-content">
                                <h3 class="item-title">Food &amp; Agriculture</h3>
                                <div class="item-count">9 Ad</div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                <li>50 Ads</li>
                                <li>25% Welcome Gift Voucher</li>
                                <li>10% save 3 Monthly Payment</li>
                                <li>25% save 6 Monthly Payment</li>


                                <li><a class="text-info text-small" href="subscription/package/view/1.html">Read
                                        More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
                            <a href="login.html" class="btn-fill-xl color-light bgPrimary">Register Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                <li>75 Ads</li>
                                <li>30% Welcome Gift Voucher</li>
                                <li>10% save 3 Monthly Payment</li>
                                <li>25% save 6 Monthly Payment</li>


                                <li><a class="text-info text-small" href="subscription/package/view/2.html">Read
                                        More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
                ...
                <div class="col-xl-4 col-md-4">
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                <li>350 Ads</li>
                                <li>35% Welcome Gift Voucher</li>
                                <li>10% save 3 Monthly Payment</li>
                                <li>25% save 6 Monthly Payment</li>


                                <li><a class="text-info text-small" href="subscription/package/view/3.html">Read
                                        More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
