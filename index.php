        ...
        <div class="container fwhite">
            <div class="row hcontent">
                <div class="col-md-6">
                    ...
                    <p>Buy, sell and rent everything from used cars to mobile phones and computers,<br> or search for property and more <strong>in Bangladesh - for free!</strong></p>
                    <br>
                    ...
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                ...
                                <li><a class="text-info text-small" href="subscription/package/view/1.html">Read More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
                    ...
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                ...
                                <li><a class="text-info text-small" href="subscription/package/view/2.html">Read More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
                            <a href="login.html" class="btn-fill-xl color-light bgPrimary">Register Now</a>
                    ...
                    <div class="pricing-box-layout1">
                        ...
                        <div class="item-features">
                            <ul>
                                ...
                                <li><a class="text-info text-small" href="subscription/package/view/3.html">Read More</a></li>
                            </ul>
                        </div>
                        <div class="item-btn">
                            <a href="login.html" class="btn-fill-xl color-light bgPrimary">Register Now</a>
