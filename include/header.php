                ...
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="index.php" class="temp-logo">
                            <img src="images/Rent2SellBD.png" alt="logo" style="max-width:200%; hight:auto; padding-bottom: 10px;">
                        </a>
                    </div>
                </div>
                    ...
                    <nav id="dropdown" class="template-main-menu">
                        <ul>
                            ...
                            <li class="d-none d-lg-block">
                                <a href="login.html" class="color-primary live-chat position-relative" data-toggle="tooltip" data-placement="top" title="Message">
                                    <i class="far fa-comment-alt" style="font-size: 18px"></i>                                </a>

                                
                            </li>
                            <li class="d-none d-lg-block">
                                <a href="login.html" class="color-primary position-relative" data-toggle="tooltip" data-placement="top" title="Cart">
