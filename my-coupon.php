...
if (!(isset($_SESSION['username']))) {
    header("location: login.php?referer=my-coupon");
}
?>
<!DOCTYPE html>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 sidebar-break-sm sidebar-widget-area mt-0" id="sticky-sidebar">
                        <div class="widget-bottom-margin widget-account-menu widget-light-bg sticky-top sticky-top-5">
                            ...
                            <ul class="nav nav-tabs flex-column" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="my-coupon.php">My coupon code</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-lg-9">
                        <div class="tab-content">
                            ...
                            <div id="coupon-code">
                                <div class="light-shadow-bg post-ad-box-layout1">
                                    <div class="light-box-content">
                                        <div class="post-section basic-information">
                                            <div class="post-ad-title">
                                                <i class="fa fa-gift"></i>
                                                <h3 class="item-title">My Coupon Code(s)</h3>
                                            </div>
