...
if (!(isset($_SESSION['username']))) {
    header("location: login.php?referer=user-account-detail");
}
?>
<!DOCTYPE html>
                    ...
                    <div class="row">
                        <div class="col-lg-3 sidebar-break-sm sidebar-widget-area mt-0" id="sticky-sidebar">
                            <div
                                ...
                                <ul class="nav nav-tabs flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="user-account-detail.php">Account
                                            details</a>
                                    </li>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content">
                                ...
                                <div id="accout-detail">
                                    <div
                                        class="light-shadow-bg post-ad-box-layout1 myaccount-store-settings myaccount-detail">
                                        <div class="light-box-content">
                                            <form action="/user/profile/details/update" method="POST"
                                                enctype="multipart/form-data">
                                                <input type="hidden" name="_token"
                                                    value="zvFIPkoGuQ2ocRaJ4ukv7KqYJuyaPFb0SIfJc9UG"> <input
                                                ...
                                                <div class="post-section basic-information">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <img src="/images/1644318068BtqHn.jpg" alt="avatar"
                                                                    width="100px">
                                                                <input type="file" class=" form-control-file pt-1"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <label for="whatsapp" class="control-label">WhatsApp
                                                            </label>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input type="tel" class="form-control " name="whatsapp"
                                                                    id="whatsapp" value="01580446839">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input type="url" class="form-control " name="website"
                                                                    id="website" value="https://www.nabilnewaz.com">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control " name="zip_code"
                                                                    id="zip_code" maxlength="4" minlength="4"
                                                                    value="1209">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-group">
                                                                <textarea name=address id=address
                                                                    class="form-control textarea " cols="30"
                                                                    rows="3">16/8, Amtola, Tollabag, Dhanmondi, Dhaka 1209</textarea>
