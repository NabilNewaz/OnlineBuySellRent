                    ...
                    <div class="col-lg-6">
                        <div class="form-box registration-form shadow p-3">
                            ...
                            <div class="d-flex justify-content-between py-3">
                                <div class="pr-1 w-50">
                                    <a href="" class="btn btn-block btn-primary btn-block"><i class="fab fa-facebook"></i> Signup with Facebook</a>
                                </div>
                                <div class="pl-1 w-50">
                                    <a href="" class="btn btn-block btn-danger btn-block"><i class="fab fa-google"></i> Signup with Google</a>
                                </div>
                            </div>
                            <form method="POST" action="#" name="signup" id="signup" class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="referral-code">Referral Code <small class="text-info">(If you have any)</small></label>
                                    <input id="referral-code" type="text" class="form-control " name="referral_code" value="">
                                </div>
                                
                                <div class="form-group">
                                <label class="control-label">User Type</label>
                                    <div class="form-check form-radio-btn">
                                        <input class="form-check-input" type="radio" name="user_type" id="user_type" value="Individual" required>
                                        <label style="padding-top: 10px; padding-right:30px;" class="form-check-label">Individual</label>
                                        <span>
                                        <input class="form-check-input" type="radio" name="user_type" id="user_type" value="Business" required>
                                        <label style="padding-top: 10px;" class="form-check-label">Business or Enterprize</label></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="form-check form-radio-btn">
                                        <input class="form-check-input" type="checkbox" id="agree" value="agreed" name="agree">
                                        <label style="padding-top: 10px; padding-right:30px;" class="form-check-label">I agree to the Terms and Conditions of  <a href="#">Rent2SellBD.com</a></label>
                                    </div>
                                </div>
                                ...
                                <div class="post-section post-contact">
                                    <div class="form-group">
                                        ...
                                        <input style="background-color:#007bff;" type="reset" value="Refresh" name="refresh" id="refresh" class="submit-btn">
                                    </div>
                                </div>
                            </form>
                        </div>
